        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 text-center">
                    <h1 class="margin-bottom">Email : <input type = "text" name="email"></h1>
                </div>
            </div>
<div class="row">
                <div class="col-sm-12 text-center">
                    <h1 class="margin-bottom">Name : <input type = "text" name="username"></h1>
                </div>
            </div>
<div class="row">
                <div class="col-sm-12 text-center">
                    <h1 class="margin-bottom">Password : <input type = "text" name="password"></h1>
                </div>
            </div>
